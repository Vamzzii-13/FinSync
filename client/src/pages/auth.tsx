  ...
  return (
    <div className="h-screen relative overflow-hidden" ref={containerRef}>
      ...
      <div className="absolute inset-0 flex items-center justify-center z-10">
        <div className="w-[420px] bg-white/95 backdrop-blur-xl relative overflow-hidden shadow-2xl rounded-3xl border border-white/30">
          {/* Glass Panel Background */}
          <div className="absolute inset-0 bg-gradient-to-br from-white/85 via-white/75 to-blue-50/50 backdrop-blur-xl rounded-3xl"></div>
          
          {/* Subtle Light Effects */}
          <div className="absolute inset-0 overflow-hidden rounded-3xl">
            <motion.div 
              className="absolute -top-12 -right-12 w-24 h-24 bg-gradient-to-br from-blue-400/20 to-violet-400/20 rounded-full blur-2xl"
              animate={{ rotate: 360 }}
              transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
            />
            <motion.div 
              className="absolute -bottom-12 -left-12 w-24 h-24 bg-gradient-to-br from-violet-400/15 to-blue-400/15 rounded-full blur-2xl"
              animate={{ rotate: -360 }}
          ...
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="relative z-10 flex flex-col justify-center p-8"
